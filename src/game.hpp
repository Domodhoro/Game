...
namespace Domodhoro
{
    ...
    public:
        ...
        void init(const std::string& file_path)
        {
            ...
            player_controller = std::make_unique<Player_Controller>(world.get(), player.get());
        }
        ...
        void update()
        {
            ...
            player_controller->handle_gravity(7);
            // Movimenta o jogador.
            player_controller->move_player(3, keyboard.get(), get_ticks());
...
private:
        ...
        std::unique_ptr<Player_Controller> player_controller;
